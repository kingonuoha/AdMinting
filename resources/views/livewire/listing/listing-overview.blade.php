<div>
            ...
            <div class="card card-flush h-lg-100">
                ...
                <div class="card-body p-9 pt-5">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <!--begin::Details-->
                        <div class="fw-semibold">
                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary">Terms of
                                Service:</a>
                            <div class="text-gray-400">{{ $listing->terms_of_service }}</div>
                        </div>
                        <!--end::Details-->
                        {{-- <!--begin::Badge-->
                        <div class="badge badge-light ms-auto">8</div>
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <select name="status" data-control="select2" data-hide-search="true"
                            ...
                            data-select2-id="select2-data-10-btdx" tabindex="-1" aria-hidden="true"
                            data-kt-initialized="1">
                            <option value="1">2020 Q1</option>
                            <option value="2">2020 Q2</option>
                            <option value="3" selected="selected" data-select2-id="select2-data-12-qicw">2020 Q3
                            </option>
                            <option value="4">2020 Q4</option>
                        </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                            data-select2-id="select2-data-11-l0wv" style="width: 100%;"><span class="selection"><span
                                    ...
                                    aria-disabled="false" aria-labelledby="select2-status-eh-container"
                                    aria-controls="select2-status-eh-container"><span
                                        class="select2-selection__rendered" id="select2-status-eh-container"
            ...
            <div class="card card-flush h-lg-100">
                ...
                <div class="card-header mt-6">
                    ...
                    <div class="card-title flex-column">
                        ...
                        <div class="fs-6 text-gray-400">Total {{ countFiles('storage/' . $folder) }} Files,
                            {{ folderSize('storage/' . $folder) }} space usage</div>
                    </div>
                    <!--end::Card title-->
                    <!--begin::Card toolbar-->
                    <div class="card-toolbar">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid select2-hidden-accessible"
                                                    ...
                                                    data-dropdown-parent="#kt_menu_62fe52d605adf"
                                                    data-allow-clear="true" data-select2-id="select2-data-16-heb1"
                                                    ...
                                                    dir="ltr" data-select2-id="select2-data-17-188l"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid"
                                                            role="combobox" aria-haspopup="true"
                                                            aria-expanded="false" tabindex="0"
                                                            aria-disabled="false"
                                                            aria-labelledby="select2-wawt-container"
                                                            aria-controls="select2-wawt-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-wawt-container" role="textbox"
                    ...
                    <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            ...
                            <div class="fw-semibold">
                                ...
                                <div class="fs-6 text-gray-700"><a
                                        onclick="event.preventDefault();document.getElementById('ListingFile').click();"
                                        href="#" class="text-hover-primary fs-5 fw-bold mb-2">File Upload</a>
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="me-5 position-relative">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                title="{{ $listing->applicant->name }}">
                                @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                    {{-- {{dd($this->user->profile_photo_url)}} --}}
                                    <img src="{{ $listing->applicant->profile_photo_url }}"
                                        alt="{{ $listing->applicant->name }} profile" />
                                @else
                                    <span
                                        class="symbol-label bg-warning text-inverse-warning fw-bold">{{ strtoupper(substr($listing->applicant->name, 0, 1)) }}</span>
                                @endif
                            </div>
                            <!--end::Image-->
                        </div>
                        ...
                        <div class="fw-semibold">
                            <a href="#"
                                class="fs-5 fw-bold text-gray-900 text-hover-primary">{{ $listing->applicant->name }}</a>
                            <div class="text-gray-400">{{ $listing->applicant->email }}</div>
                        </div>
                        <!--end::Details-->
                        <!--begin::Badge-->
                        @if (auth()->user()->id == $listing->applicant->id ||
                                auth()->user()->id == $listing->user->id ||
                                auth()->user()->role == 'adm_admin')
                            <div class="btn btn-sm btn-light-success text-success ms-auto"><a
                                    href="{{ route('user', $listing->applicant->id) }}">Chat User</a></div>
                        @else
            ...
            <div class="card card-custom card-stretch gutter-b">
                <div class="card-body d-flex p-0">
                    <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start"
                        style="background-color: #dee2ff; background-position: right bottom; background-size: auto 100%; background-image: url({{ asset('users/assets/media/custom/report.svg') }})">

                        <h4 class="text-primary font-weight-bolder m-0">Resolve Disputes with Confidence</h4>
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#dispute-modal"
                            class="btn btn-primary font-weight-bold py-2 px-6">Report an Issue</a>
                    </div>
                </div>
            </div>
        </div>

        <div class="modal fade" id="dispute-modal" tabindex="-1" aria-hidden="true" wire:ignore.self>
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    <!--begin::Form-->
                    {{-- <form class="form" method="post" action="{{route('listing.store')}}" id="dispute-modal_form"> --}}
                    <form class="form" wire:submit.prevent="saveDispute">
                        @csrf
                        <!--begin::Modal header-->
                        <div class="modal-header" id="dispute-modal_header">
                            <!--begin::Modal title-->
                           ...
                           @endif --}}
                            <!--end::Modal title-->
                            <!--begin::Close-->
                            <div id="dispute-modal_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7 d-flex flex-column" id="dispute-modal_scroll" data-kt-scroll-offset="300px">

                                <div class="fv-row mb-5">
                                    <label for="name" class="fs-4 fw-bolder form-label mb-2">Description</label>
                                    <textarea wire:model="dispute_description" id="" cols="30" rows="10" class="form-control"
    ...
    @push('script')
        ...
        <script>
            // var myDropzone = new Dropzone("div#despute_dropzone", {
            ...
            //         //  formData.append("lsting_id", "{{ $listing->id }}");
        ...
        window.addEventListener('closeDisputeModal', (e)=>{
            $("#dispute-modal").modal('hide');
        })
