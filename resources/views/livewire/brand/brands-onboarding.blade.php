<div >
    <div class="d-flex flex-column flex-lg-row flex-column-fluid stepper stepper-pills stepper-column stepper-multistep" id="kt_advertiser_onboarding">
        ...
        <div  wire:ignore.self class="d-flex flex-column flex-lg-row-auto w-lg-350px w-xl-500px">
            <div wire:ignore class="d-flex flex-column position-lg-fixed top-0 bottom-0 w-lg-350px w-xl-500px scroll-y bgi-size-cover bgi-position-center" style="background-image: url({{asset('users/assets/media/misc/auth-bg.png')}})">
                <!--begin::Header-->
                    ...
                    <div class="stepper-nav">
                        ...
                        <div class="stepper-item current" data-kt-stepper-element="nav">
                            ...
                            <div class="stepper-wrapper">
                                ...
                                <div class="stepper-label">
                                    <h3 class="stepper-title fs-2">Brand Info</h3>
                                    <div class="stepper-desc fw-normal">Tell us a little more about Your Brand</div>
                                </div>
                                <!--end::Label-->
                            </div>
                            <!--end::Wrapper-->
                        ...
                        <div class="stepper-item" data-kt-stepper-element="nav">
                            ...
                            <div class="stepper-wrapper">
                                ...
                                <!--begin::Label-->
                                <div class="stepper-label">
                                    <h3 class="stepper-title fs-2">Brand Details</h3>
                                    <div class="stepper-desc fw-normal">Set up informations about your Brand</div>
                                </div>
                                <!--end::Label-->
                            </div>
                            <!--end::Wrapper-->
                        ...
                        <div class="stepper-item" data-kt-stepper-element="nav">
                            ...
                            <div class="stepper-wrapper">
                                ...
                                <!--begin::Label-->
                                <div class="stepper-label">
                                    <h3 class="stepper-title fs-2">Brand Socials</h3>
                                    <div class="stepper-desc fw-normal">                                    <div class="stepper-desc fw-normal">Link up your brand socials</div>
                                </div>
                                </div>
                                <!--end::Label-->
                            </div>
                        ...
                        <div class="stepper-item" data-kt-stepper-element="nav">
                            ...
                            <div class="stepper-wrapper">
                                ...
                                <!--begin::Label-->
                                <div class="stepper-label">
                                    <h3 class="stepper-title">Extra Security</h3>
                                    <div class="stepper-desc fw-normal">Secure your account with AdMinting</div>
                                </div>
                                <!--end::Label-->
                            </div>
                            <!--end::Wrapper-->
                ...
                <div  class="w-lg-650px w-xl-700px p-10 p-lg-15 mx-auto">
                    ...
                    {{-- <form class="my-auto pb-5" novalidate="novalidate" id="kt_create_account_form" data-kt-redirect-url="account/overview.html"> --}}
                        ...
                        <div  wire:ignore.self class="current" data-kt-stepper-element="content">
                            <!--begin::Wrapper-->
                            <div class="w-100">
                                <h1>We need a little more informaton about your Brand</h1>
                                ...
                                <div class="pb-10 pb-lg-15">
                                    <!--begin::Title-->
                                    <h2 class="fw-bold d-flex align-items-center text-dark">Brand Info 
                                ...
                                <form wire:submit.prevent="stepOne">
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input wire:model.lazy="brand_name" class="form-control form-control-lg form-control-solid" placeholder="e.g. - Keenthemes Inc.">
                                        <!--end::Input-->
                                        @error('brand_name') <div class="fv-plugins-message-container invalid-feedback">{{$message}}</div> @enderror
                                    </div>
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        <!--begin::Label-->
                                        <label class="form-label required">Date of Inception</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input wire:model="inception_date" class="form-control form-control-lg form-control-solid" id="kt_datepicker_1"  placeholder="Pick a date">
                                        <!--end::Input-->
                                        @error('inception_date') <div class="fv-plugins-message-container invalid-feedback">{{$message}}</div> @enderror
                                    </div>
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <div class="row ">
                                            <div class="card card-flush py-4">
												...
												<!--end::Card header-->
												<!--begin::Card body-->
												<div class="card-body text-center row pt-0">
                                                    <div class="col-lg-6">
													...
													<style>.image-input-placeholder { background-image: url('{{asset('users/assets/media/svg/files/blank-image.svg')}}'); } [data-theme="dark"] .image-input-placeholder { background-image: url('../../../assets/media/svg/files/blank-image-dark.svg'); }</style>
                        ...
                        <div wire:ignore.self class="" data-kt-stepper-element="content" >
                            <!--begin::Wrapper-->
                            <div class="w-100" data-select2-id="select2-data-12-y7t5">
                            <form wire:submit.prevent="stepTwo">
                                        ...
                                        <div class="mb-5 fv-row">
                                            ...
                                            <div wire:ignore.self>
                                                <input class="form-control form-control-solid" wire:model="selected_category" id="category_tagify_1"/>
                                            </div>
                                        ...
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                            ...
                                            <label class="d-flex align-items-center form-label">
                                                ...
                                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Customers will see this shortened version of your statement descriptor" data-kt-initialized="1"></i>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            
                                            <input wire:model="short_desc" class="form-control form-control-lg form-control-solid" value="KEENTHEMES">
                                            <!--end::Input-->
                                            <!--begin::Hint-->
                                            @error('short_desc') <div class="fv-plugins-message-container invalid-feedback">{{$message}}</div> @enderror
                                        ...
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea wire:model="description" class="form-control form-control-lg form-control-solid" rows="3"></textarea>
                                            <!--end::Input-->
                                            @error('description') <div class="fv-plugins-message-container invalid-feedback">{{$message}}</div> @enderror
                                        ...
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input wire:model="brand_email" class="form-control form-control-lg form-control-solid" placeholder="eg ({{'contact@company.com'}})">
                                            <!--end::Input-->
                                            @error('brand_email') <div class="fv-plugins-message-container invalid-feedback">{{$message}}</div> @enderror
                                        ...
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                            <!--end::Label-->
                                            <label class="form-label">Business Headquarters Location</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea wire:model="location" name="business_description" class="form-control form-control-lg form-control-solid" rows="2" ></textarea>
                                            <!--end::Input-->
                                            @error('location') <div class="fv-plugins-message-container invalid-feedback">{{$message}}</div> @enderror
                                        ...
                                        <div class="fv-row mb-10 fv-plugins-icon-container">
                                            <!--end::Label-->
                                            <label class="form-label">Brand Contact Numbers</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <button type="button" wire:click="showAddNumber" class="d-flex justify-content-between btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center mb-10" for="kt_create_account_form_account_type_personal">
                                                ...
                                                <span class="d-block fw-semibold text-start">
                                                    <span class="text-dark fw-bold d-block fs-4 mb-2">Click to Add </span>
                                                    <span class="text-muted fw-semibold fs-6">pls add your brand official Phone number</span>
                                                </span>
                                                <!--end::Info-->
                                                <!--begin::Line-->
                                                   <div class="stepper-line h-40px"></div>
                                        ...
                                        <div class="card-body border-top p-9">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        <form method="POST" action="{{ route('verification.send') }}">
                                                            ...
                                                            <div>
                                                               <button class="btn btn-outline btn-outline-dashed btn-outline-info btn-active-light-info"> {{ __('Resend Verification Email') }}</button>
                                                            </div>
                                                        </form>
                                                        @else
                                            ...
                                            <div class="d-flex flex-stack pt-15">
                                                ...
                                                <div>
                                                    ...
                                                    <button type="button" class="btn btn-lg btn-primary" wire:click="stepFour" >Continue 
                                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg')}}-->
                                                    <span class="svg-icon svg-icon-4 ms-1">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="currentColor" />
                            ...
                            <div class="w-100">
                                ...
                                <div class="pb-8 pb-lg-10">
                                    <div class="card card-flush h-md-100">
                                        <!--begin::Body-->
                                        <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('{{asset('user/assets/media/stock/900x600/42.png')}}')">
                                            <!--begin::Wrapper-->
                                            <div class="mb-10">
                                                <!--begin::Title-->
                                                ...
                                                <span class="position-relative d-inline-block text-danger">
                                                    <a href="{{route('dashboard')}}" class="text-danger opacity-75-hover">Dashboard</a>
                                                    <!--begin::Separator-->
                                                    <span class="position-absolute opacity-15 bottom-0 start-0 border-4 border-danger border-bottom w-100"></span>
                                                    <!--end::Separator-->
                                                </span></span>To get full experience!</div>
                                                <!--end::Title-->
                                                <!--begin::Action-->
                                            ...
                                            <!--begin::Wrapper-->
                                            <!--begin::Illustration-->
                                            <img class="mx-auto h-200px h-lg-300px " src="{{asset('users/assets/media/illustrations/sketchy-1/17.png')}}" alt="">
                                            <!--end::Illustration-->
                                        </div>
                                        <!--end::Body-->
                                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title">Enter Institution</h3>
                    ...
                    <div class="modal-body">
                            <div class="row mb-3">
                                <div class="col-12 mb-3">
                                   ...
                                   <input class="form-control mb-5" placeholder="EG(+234 1234 567 89011)" type="tel" wire:model="phone_number" >
                                    <span class="text-danger">@error('phone_number') {{$message}} @enderror</span>
                                    <!--end::Input-->
                                    <div class="text-muted">Made a mistake? no worries, Enter Number again to delete from record</div>
                                </div>
...
@push('select2Script')
    <script defer>
            ...
            var category_input = document.querySelector("#category_tagify_1");
            //tagify
