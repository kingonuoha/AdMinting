<div >
    <div class="text-center mb-13">
        ...
        <!--end::Title-->
        <!--begin::Description-->
        <div class="text-muted fw-semibold fs-5">Total Users that has applied for this Job Listings </div>
    ...
    <div class="mb-15">
        ...
        @if (!is_null($applicant->advertiserInfos))
                    ...
                    <div class="d-flex">
                        ...
                        <div class="symbol symbol-35px symbol-circle">
                            ...
                            {{-- {{dd($this->user->profile_photo_url)}} --}}
                                ...
                                @else
                                        ...
                                        <span class="symbol-label bg-light-danger text-danger fw-semibold">{{strtoupper(substr($applicant->name, 0, 1))}}</span>
                                @endif
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Details-->
                        <div class="ms-5">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="{{route('user.profile.show', $applicant->id)}}" class="text-dark fw-bold text-hover-primary fs-5 me-4">{{ucwords($applicant->name)}}</a>
                                <!--begin::Label-->
                                ...
                                <!--end::Svg Icon-->{{ucwords($applicant->role)}}</span>
                                <!--end::Label-->
                            </div>
                            <!--end::Name-->
                            <!--begin::Desc-->
                ...
                <!--begin::Wrapper-->
                    ...
                    <div class="p-0">
                        ...
                        <div class="d-flex flex-column">
                            <!--begin::Text-->
                            <p class="text-gray-700 fw-semibold fs-6 mb-4">{{substr($applicant->advertiserInfos->bio, 0, 160)}}...</p>
                            <!--end::Text-->
                            <!--begin::Tags-->
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <!--end::Progress-->
                                <!--begin::Button-->
                                <button href="#" wire:loading.attr="disabled" wire:click.prevent="selectUserForListing({{$applicant}}, {{$listing}})" class="btn btn-sm btn-primary"> 
                                    <span class="indicator-label" wire:loading.remove wire:target="selectUserForListing({{$applicant}}, {{$listing}})">
                                    Select
                                    </span>
                                    <span class="indicator-progress" wire:loading wire:target="selectUserForListing({{$applicant}}, {{$listing}})">
            ...
            <div class="card-px text-center py-20 my-10">
                ...
                <!--begin::Action-->
                <a href="{{route('dashboard')}}" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#adm_modal_create_job">Back to Dashboard</a>
