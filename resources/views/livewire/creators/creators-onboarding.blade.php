                        ...
                        <div wire:ignore.self class="" data-kt-stepper-element="content" >
                            ...
                            <div class="w-100">
                                ...
                                <div class="mb-5 fv-row">
                                    ...
                                    {{-- {{ $selected_category}} --}}
                                    <div wire:ignore>
                                        <input  class="form-control form-control-solid" wire:model.lazy="selected_category" id="category_tagify"/>
                                    </div>
                                ...
                                <div class="mb-5 fv-row row">
                                    <!--begin::Input wrapper-->
                                    <div class="w-lg-50 col-lg-6">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold mb-2">
                                           Choose Min Price Tag
                                        ...
                                        <!--begin::Slider-->
                                       <input wire:model="min_price" type="number" class="form-control form-control-solid" placeholder="Enter your Min Price tag" min="5" max="400">
                                        <!--end::Slider-->
                                        <div class="fv-plugins-message-container invalid-feedback">@error('min_price')
                                            {{$message}}
                                        @enderror</div>
                                   <span class="text-muted my-2">Choose a value between $5 and $400</span>

                                    </div>
                                    <div class="w-lg-50 col-lg-6">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-semibold mb-2">
                                           Choose Max Price Tag
                                        ...
                                        <!--begin::Slider-->
                                       <input wire:model="max_price" type="number" class="form-control form-control-solid" placeholder="Enter your Max Price tag" min="5" max="400">
                                        <!--end::Slider-->
                                        <div class="fv-plugins-message-container invalid-feedback">@error('max_price')
                                            {{$message}}
                                        @enderror</div>
                                   <span class="text-muted my-2">Choose a value between $5 and $400</span>
                                ...
                                <!--end::Input wrapper-->
                                   <button class="btn-primary btn mt-2" type="button" wire:click="make_min_max_null">Select all Price Tags</button>
                                   <span class="text-muted my-2">click the above button to get listings of all price tags</span>
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="mb-5 fv-row">
                                        ...
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="d-flex flex-stack pt-15">
                                                ...
                                                <div>
                                                    ...
                                                    <button type="button" class="btn btn-lg btn-primary" wire:click="stepFour" wire:loading.attr="disabled">
                                                        <span class="indicator-label" wire:loading.remove wire:target="stepFour">
                                                            Continue 
                                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg')}}-->
                                                    <span class="svg-icon svg-icon-4 ms-1" >
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <span class="indicator-progress" wire:loading wire:target="stepFour">Please wait... 
                                                        <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                    </button>
                                                </div>
                                            </div>
                    ...
                    <div class="modal-body">
                            <div class="row mb-3">
                                <div class="col-12 mb-3">
                                   ...
                                   <input class="form-control" placeholder="EG(+234 1234 567 89011)" type="tel" wire:model="phone_number" >
