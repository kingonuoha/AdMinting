                    ...
                    <div class="col-md-4 col-l-3">
                        ...
                        <div class="card-xl-stretch me-md-6">
                            ...
                            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                href="{{ $post->full_picture === '(no-media)' ? 'https://placehold.co/800?text=No+Photo&font=roboto' : $post->full_picture }}">
                                <!--begin::Image-->
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                    style="background-image:url('{{ $post->full_picture === '(no-media)' ? 'https://placehold.co/800?text=No+Photo&font=roboto' : $post->full_picture }}')">
                                </div>
                                <!--end::Image-->
                                <!--begin::Action-->
                            ...
                            <div class="mt-5">
                                ...
                                <div class="fs-6 fw-bold mt-5 d-flex flex-stack">
                                    ...
                                    <span class="badge border border-dashed fs-6 fw-semibold text-gray-600  p-2">
                                        {{ date_formatter($post->created_time) }}</span>
                                    <!--end::Action-->
                                </div>
                                <!--end::Text-->
                            </div>
