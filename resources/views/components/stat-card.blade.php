{{-- <div class="row g-5 g-xl-8"> --}}
    <div class="col-xl-3 stats-card">
        <!--begin::Statistics Widget 5-->
        <div href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
            <!--begin::Body-->
            <div class="card-body">
                <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                <span class="svg-icon svg-icon-{{$stat['color']}} svg-icon-3x ms-n1">
                {{-- <span class="svg-icon svg-icon-3x svg-icon-warning d-block ms-n1"> --}}
                    {!! getIcon($stat['icon']) !!}
                </span>
                <!--end::Svg Icon-->
