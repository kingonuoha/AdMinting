...
// Sound notifications 
  /* Default Notifications */
  function default_noti_sound(message, sound, imgSrc,  type = "default") {
	Lobibox.notify(type, {
		pauseDelayOnHover: true,
		continueDelayOnInactiveTab: false,
		position: 'top right',
  ...
  /* Default Notifications */
  function info_noti_sound(message, sound) {
	Lobibox.notify('info', {
		pauseDelayOnHover: true,
		continueDelayOnInactiveTab: false,
		position: 'top right',
  ...
  /* Default Notifications */
  function success_noti_sound(message, sound) {
	Lobibox.notify('success', {
		pauseDelayOnHover: true,
		continueDelayOnInactiveTab: false,
		position: 'top right',
  ...
  /* Default Notifications */
  function error_noti_sound(message, imgSrc) {
	Lobibox.notify('error', {
		pauseDelayOnHover: true,
		continueDelayOnInactiveTab: false,
		position: 'top right',
  ...
  /* Default Notifications */
  function warning_noti_sound(message, sound) {
	Lobibox.notify('warning', {
		pauseDelayOnHover: true,
		continueDelayOnInactiveTab: false,
		position: 'top right',
